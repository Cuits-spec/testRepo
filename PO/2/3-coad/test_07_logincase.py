...
class TestLogin:
    ...
    def setup_class(self):
        ...
        self.end = test_09_popattern.Business()
    #     # 2.创建浏览器驱动对象
    ...
    def test_password_error(self):
        ...
        self.end.haha("15800000001","error","8888")
    ...
    def test_account_not_exist(self):
        # 6.执行登陆业务
        self.driver.find_element_by_class_name("red").click()
        self.end.haha("15800000021","123456","8888")
